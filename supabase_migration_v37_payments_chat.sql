-- ════════════════════════════════════════════════════════════════════════
-- Migration v37 — Payments + Staff Messages
-- ════════════════════════════════════════════════════════════════════════
-- PREREQUISITE: v35 (get_my_role), v36 (clinics) musia byt hotove
-- ════════════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS public.payments (
  ...
  method           TEXT        NOT NULL DEFAULT 'cash'
                   CHECK (method IN ('cash','card','online','insurance')),
...
-- ── 3. Realtime pre staff_messages ──────────────────────────────────────
ALTER PUBLICATION supabase_realtime ADD TABLE public.staff_messages;

-- ════════════════════════════════════════════════════════════════════════
-- Verifikacia:
-- SELECT id, amount_cents, status FROM public.payments LIMIT 5;
-- SELECT id, body, sender_id FROM public.staff_messages LIMIT 5;
-- ════════════════════════════════════════════════════════════════════════
