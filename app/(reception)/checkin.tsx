...
const STATUS_CFG: Record<string, { label: string; bg: string; text: string; border: string }> = {
  ...
  checkout:      { label: 'Účet',         bg: '#FEF3E2', text: '#B87333', border: '#FAD7A0' },
...
const s = StyleSheet.create({
  ...
  heroTitle: { ...TYPO.h1, color: '#F5F6F8', marginBottom: 12 },
  ...
  searchInput: { flex: 1, ...TYPO.body, color: '#F5F6F8', padding: 0 },
