...
const styles = StyleSheet.create({
  ...
  summaryBox:  { flex: 1, borderRadius: 2, borderWidth: 1.5, padding: 12, alignItems: 'center' },
  ...
  planInput:      { borderWidth: 1.5, borderRadius: 2, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, marginBottom: 18 },
  planMonthsRow:  { flexDirection: 'row', gap: 10, marginBottom: 20 },
  planMonthBtn:   { flex: 1, paddingVertical: 12, borderRadius: 2, borderWidth: 1.5, alignItems: 'center' },
  planMonthText:  { fontSize: 14, fontFamily: 'DMSans_500Medium' },
  planResult:     { borderWidth: 1.5, borderRadius: 2, padding: 16, marginBottom: 20, alignItems: 'center' },
