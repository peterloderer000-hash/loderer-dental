...
const styles = StyleSheet.create({
  ...
  filterChipBadge:        { backgroundColor: COLORS.bg3, borderRadius: 8, paddingHorizontal: 5, paddingVertical: 1 },
  ...
  recallChip:  { backgroundColor: '#FEF9E7', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 1, marginLeft: 4, borderWidth: 1, borderColor: '#F9E79F' },
  ...
  wlBtnBook:       { flex: 1.4, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4, paddingVertical: 7, borderRadius: 8, backgroundColor: COLORS.wal },
  wlBtnBookText:   { fontSize: 11, fontWeight: '700', color: '#fff' },
  wlBtnMsg:        { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4, paddingVertical: 7, borderRadius: 8, backgroundColor: '#EBF5FB', borderWidth: 1, borderColor: '#AED6F1' },
  wlBtnMsgText:    { fontSize: 11, fontWeight: '700', color: '#1A5276' },
  wlBtnDone:       { width: 30, alignItems: 'center', justifyContent: 'center', paddingVertical: 7, borderRadius: 8, backgroundColor: '#1E8449' },
