...
const styles = StyleSheet.create({
  ...
  templateChip:        { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: COLORS.cream, borderRadius: 2, padding: 12, marginBottom: 6, borderWidth: 1, borderColor: COLORS.bg3 },
  ...
  consentRow:    { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: COLORS.cream, borderRadius: 2, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: COLORS.bg3 },
