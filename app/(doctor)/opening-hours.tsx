...
const s = StyleSheet.create({
  ...
  timeInput: {
    ...
    borderRadius: 2, textAlign: 'center', fontSize: 14,
  ...
  saveBtn:     { backgroundColor: COLORS.gold, paddingVertical: 15, borderRadius: 2, alignItems: 'center', marginTop: 20 },
  saveBtnText: { color: COLORS.esp, fontSize: 16, fontWeight: '800' },

  sectionTitle:  { fontSize: 14, fontWeight: '800' },
  sectionSub:    { fontSize: 12, marginBottom: 14, fontStyle: 'italic' },
  addExBtn:      { flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 2, borderWidth: 1.5, paddingHorizontal: 12, paddingVertical: 6 },
  addExBtnText:  { fontSize: 12, fontWeight: '700' },
  exForm:        { borderRadius: 2, borderWidth: 1, padding: 14, marginBottom: 14 },
  exLabel:       { fontSize: 9, letterSpacing: 1.5, fontWeight: '700', textTransform: 'uppercase', marginTop: 12, marginBottom: 6 },
  exInput:       { borderWidth: 1.5, borderRadius: 2, padding: 11, fontSize: 14, marginBottom: 2 },
  ...
  exRow:         { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 2, borderWidth: 1, padding: 12, marginBottom: 8 },
  exDateBox:     { borderRadius: 2, paddingHorizontal: 10, paddingVertical: 6, alignItems: 'center', minWidth: 54 },
