...
const styles = StyleSheet.create({
  ...
  ratingRow:   { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 6, marginBottom: 4, backgroundColor: '#FEFCE8', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6 },
