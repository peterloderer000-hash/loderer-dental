...
const ms = StyleSheet.create({
  ...
  deleteBtn:  { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 14, alignSelf: 'flex-start', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 2, backgroundColor: 'rgba(231,76,60,0.15)' },
  deleteBtnText: { fontSize: 12, fontWeight: '600', color: '#C0392B' },
});
...
const styles = StyleSheet.create({
  ...
  tab:         { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 11, paddingVertical: 5, borderRadius: 4, backgroundColor: 'rgba(255,255,255,0.1)' },
  ...
  viewToggle:  { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 2, padding: 2 },
  viewBtn:     { paddingHorizontal: 8, paddingVertical: 5, borderRadius: 2 },
  ...
  previewImg:  { width: '100%', height: 130, borderRadius: 2, marginBottom: 10 },
  formInput:   { borderWidth: 1.5, borderRadius: 2, paddingHorizontal: 12, paddingVertical: 9, fontSize: 13, marginBottom: 8 },
  catChip:     { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 2, borderWidth: 1.5 },
  ...
  attThumb:      { width: 66, height: 66, borderRadius: 2, backgroundColor: COLORS.cream },
