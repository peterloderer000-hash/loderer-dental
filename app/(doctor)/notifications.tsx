...
const TYPE_CONFIG = {
  info:    { icon: 'information-circle' as const, color: '#1A5276', bg: '#EBF5FB' },
  success: { icon: 'checkmark-circle'   as const, color: '#1E8449', bg: '#EAFAF1' },
  warning: { icon: 'warning'            as const, color: '#7D6608', bg: '#FEF9E7' },
  error:   { icon: 'close-circle'       as const, color: '#922B21', bg: '#FDEDEC' },
};
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      {loading ? (
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.emptySub}>Tu sa zobrazia správy o termínoch.</Text>
        </View>
      ) : (
...
const styles = StyleSheet.create({
  ...
  card:       { flexDirection: 'row', alignItems: 'flex-start', gap: 12, backgroundColor: '#fff', marginHorizontal: SIZES.padding, marginBottom: 8, borderRadius: 14, padding: 14, borderLeftWidth: 4, borderWidth: 1, borderColor: COLORS.bg3, elevation: 1 },
