...
const styles = StyleSheet.create({
  ...
  audienceCard: { width: '47%', padding: 12, borderRadius: 2, backgroundColor: COLORS.cream, borderWidth: 1.5, borderColor: COLORS.bg3, gap: 6 },
  audienceIcon: { width: 32, height: 32, borderRadius: 4, alignItems: 'center', justifyContent: 'center' },
  audienceLabel:{ fontSize: 12, fontWeight: '700', color: COLORS.esp },
  audienceDesc: { fontSize: 11, color: COLORS.wal, lineHeight: 14 },

  customSection:{ backgroundColor: COLORS.cream, borderRadius: 2, borderWidth: 1, borderColor: COLORS.bg3, marginBottom: 20, overflow: 'hidden' },
  ...
  templateChip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 9, borderRadius: 4, backgroundColor: COLORS.cream, borderWidth: 1.5, borderColor: COLORS.bg3 },
  templateEmoji:{ fontSize: 14 },
  templateLabel:{ fontSize: 12, fontWeight: '600', color: COLORS.esp },

  input:        { backgroundColor: COLORS.cream, borderRadius: 2, borderWidth: 1.5, borderColor: COLORS.bg3, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, color: COLORS.esp, marginBottom: 4 },
