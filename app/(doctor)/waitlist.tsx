...
const styles = StyleSheet.create({
  ...
  detailChip: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: COLORS.bg2, borderRadius: 2, paddingHorizontal: 9, paddingVertical: 5, borderWidth: 1, borderColor: COLORS.bg3 },
  ...
  notesRow:   { flexDirection: 'row', alignItems: 'flex-start', gap: 6, backgroundColor: COLORS.bg2, borderRadius: 2, padding: 8, marginBottom: 10 },
