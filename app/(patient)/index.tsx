...
const styles = StyleSheet.create({
  ...
  avatarImg: { width: 44, height: 44, borderRadius: 4 },
  ...
  queueCard:  { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 2, borderWidth: 1.5, padding: 14 },
  ...
  twinBanner: { borderRadius: 4, overflow: 'hidden' },
  ...
  postVisitCard:   { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 2, borderWidth: 1.5, padding: 14 },
  postVisitIcon:   { width: 44, height: 44, borderRadius: 4, alignItems: 'center', justifyContent: 'center' },
