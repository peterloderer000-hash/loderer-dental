...
const qrS = StyleSheet.create({
  ...
  qrWrap:     { backgroundColor: COLORS.cream, borderRadius: 4, padding: 12, marginBottom: 20, elevation: 4 },
  qr:         { width: 220, height: 220 },
  card:       { width: '100%', borderRadius: 2, borderWidth: 1.5, padding: 14, gap: 4, marginBottom: 20 },
